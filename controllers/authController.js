...
exports.autenticarUsuario = async (req, res) => {
  ...
  try {
    ...
    //06.Firmar/crear el JWT---------------------------------------------------------------->
    /**OJO!!! con este payload/variable/parametro que le pasa 
     * const payload={usuario:{id:usuario.id}};
     * osea mete el sign/crear/firmar el token la información
     * del usuario!!!!!!!!! cada vez que crea un token!!!!!
    */
