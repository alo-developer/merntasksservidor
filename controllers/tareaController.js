...
exports.actualizarTarea = async (req, res) => {
  try {
    ...
    // if(estado){nuevaTarea.nombre = estado;}
    /**   OJO CON ESTO DE PONERLO DE UNA MANERA O DE OTRA ( esto es el estado de completo e incompleto que cambia de color)
     *  if(nombre){nuevaTarea.nombre = nombre;} : este te avalua la condicion de false que es 
     * como se inicializa a true y AU! nada mas
     *     nuevaTarea.nombre = nombre; : este se lo traga y añada el campo nombre o 
     * el campo esta se lo traga todo*/
