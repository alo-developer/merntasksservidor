...
const conectarDB = async () => {
    try {
        ...
        await mongoose.connect(process.env.DB_MONGO, {
            ...
            useCreateIndex:true,//ESTA LINEA LA HE AÑADIDO YO ========================================
        //POR QUE ME DABA ESTE ERROR EN LA TERMINAL DEL VISUAL STUDIO CON EL SERVIDOR
        //AL HACER npm run dev
        //(node:5906) DeprecationWarning: collection.ensureIndex is deprecated. Use createIndexes instead.
        });
